...
@router.post("/", response_model=paczka_danych_schemas.PaczkaDanych)
async def create_paczka_danych(paczka_danych: paczka_danych_schemas.PaczkaDanychCreate, db: Session = Depends(get_db)):
