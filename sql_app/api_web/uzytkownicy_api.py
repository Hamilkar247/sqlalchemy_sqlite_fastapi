...
async def create_uzytkownik(uzytkownik: schemas.UzytkownikCreate, db: Session = Depends(get_db)):
...
@router.get("/id={uzytkownik_id}", response_model=schemas.Uzytkownik)
